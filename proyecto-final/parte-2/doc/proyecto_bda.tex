...
\begin{table}[H]
  ...
  \resizebox{\linewidth}{!}{\begin{tabular}{|c | c |} 
   ...
   \hline
   \multirow{6}{4em}{usersPay01} & tamaño inicial de 500M \\
    ...
    \hline
    \multirow{5}{6em}{multimediaUsrTbs} & tamaño inicial de 200M \\
    & Autoextend al llegar al máximo ilimitada \\
    & gestion local automatica de extensiones \\
    & gestion automatica de segmentos \\
    & ubicación datafile /disk\_5/app/oracle/oradata/VRAPROY/multimediaUsrTbs01.dbf \\
   \hline
  \end{tabular}}
  \caption{Definición de tablespaces comunes a los módulos}
  \label{tabla:6}
\end{table}
