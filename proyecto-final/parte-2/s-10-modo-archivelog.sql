...
alter system set log_archive_dest_1='LOCATION=/disk_6/app/oracle/oradata/VRAPROY/arch' scope=both;
alter system set log_archive_dest_2='LOCATION=/disk_2/app/oracle/oradata/VRAPROY/arch' scope=both;
